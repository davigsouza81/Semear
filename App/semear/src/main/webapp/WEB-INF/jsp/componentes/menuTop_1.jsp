...
<nav class="navbar navbar-default navbar-fixed-top menuTop">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a id="logo" class="navbar-brand" href="#top" alt="Semear | Sistema de Compartilhamento Acadêmico." rel="nofollow" ></a>
